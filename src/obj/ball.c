...
static void render(O_Ball *e)
{
	...
	spr_put(sp_x, sp_y, SPR_ATTR(s_vram_pos + frames[e->anim_frame].tile, 0, 0,
...
static void main_func(Obj *o)
{
	...
	pal_upload(ENEMY_CRAM_POSITION, res_pal_enemy_ball_bin,
	           sizeof(res_pal_enemy_ball_bin) / 2);
}
