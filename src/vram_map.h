...
#define PARTICLE_VRAM_POSITION (POWERUP_VRAM_POSITION + 1792)
#define PROJECTILE_VRAM_POSITION (PARTICLE_VRAM_POSITION + 2688)
#define PAUSE_VRAM_POSITION (PROJECTILE_VRAM_POSITION + 928)

#define OBJ_TILE_VRAM_POSITION (PAUSE_VRAM_POSITION + 8192)
